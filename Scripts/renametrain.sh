...
while read line; 
do 
for file in /Users/johnfernandez/Documents/"Spring 23"/"CS 4701"/Guess-a-Sketch/NewTrainingData/"$line"/*
do 
let count++ 
# echo $file
# mv "$file" /Users/johnfernandez/Documents/"Spring 23"/"CS 4701"/Guess-a-Sketch/NewTrainingData/"$line"/"$count".png;
echo $count 
# echo $line
done;
